...
**Package-by-feature (recommended for growing projects):**
```
...
**Package-by-layer (OK for small projects):**
```
src/main/java/com/example/demo/
├── controller/
├── service/
...
- Controller handles HTTP, validation, authentication, response mapping
- Service handles business logic, transactions, domain orchestration
- Repository handles data persistence only
- Business logic must NOT exist in Controller, Repository, DTO, or Entity
